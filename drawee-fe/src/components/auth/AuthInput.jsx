  ...
  return (
    <div className="relative">
      <input
        ...
        value={value}
        className="w-full rounded-full border border-white/20 bg-white/5 px-4 py-2 pr-12 text-white outline-none transition placeholder:text-white/60 focus:border-[#A6C9B6]"
      />
